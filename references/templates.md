...
針對 AI 伺服器或一般伺服器散熱應用，目前可以先參考 Maxtor thermal paste 與 PTM 兩個方向。導熱膏部分主要有 CTG8、CTG10、CTG12；PTM／相變化材料則可以看 XTP-001。

如果您目前有在使用 DowSil TC-5888、Shin-Etsu 7950 / 7958 或類似材料，後續我也可以整理對應的 TDS 給您做初步比較。

附件先給您參考。方向接近的話，我再補更完整的規格資料。
