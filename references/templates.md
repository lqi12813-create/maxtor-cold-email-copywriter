# Maxtor Outreach Templates

Use these as patterns, not rigid scripts. Personalize the opening line and choose one product angle.

## First Touch: Distributor / OEM Buyer
...
## First Touch: PC DIY / Gaming Reseller
...
## First Touch: Server / Data Center Maintenance
...
COMPUTEX 後續補一份 Maxtor 的導熱材料圖冊給您參考。

今年展會上不少客戶提到 AI 伺服器用的 PTM / 相變介面材料；如果貴司也在比較導熱膏與 PTM 路線，Maxtor 這邊除了 CTG8、CTG10、CTG12 導熱膏，也有 XTP-001 相變材料可一起了解。

我們主要做導熱介面材料的研發與製造，已有 15 年經驗。附件先放產品圖冊，您這邊有空時可以先看一下。

後續如果有具體平台、厚度或現用材料需要對比，我再補對應的 TDS 給您。
