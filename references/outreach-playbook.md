# Maxtor Outreach Playbook

## Brand And Sender Rules
...
| Recipient country / region | Email language |
|---|---|
...
### Distributor / Importer / OEM Buyer

Use when the buyer sells thermal paste, electronics accessories, computer parts, industrial consumables, or imports private-label products.

Angle:

- Professional TIM factory with OEM/ODM capability.
...
## Batch Sending Safety

For actual sending workflows:
...
- After send, update CRM status and notes if operating with CRM tools.
...
- All caps.
- "Urgent", "Best price!!!", "Top quality guaranteed".
- Overly long technical strings.
...
- Is the email under 150 words unless the user asked for a detailed version?
- Is the signature Maxtor, not Coxbyte?
